...
9. Never claim a version the project does not have — no version badge, "requires vX" or tag-pinned install line beyond what the [versioning](https://github.com/rokokol/versioning-skill) skill says the repository has
